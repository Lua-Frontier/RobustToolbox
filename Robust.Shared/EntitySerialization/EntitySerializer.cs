    ...
    ITypeSerializer<MapId, ValueDataNode>
{
        ...
        ISerializationContext? context = null)
    {
        ...
        // References to entities which are queued for deletion are stale even though their metadata may survive
        // until the end of the tick. Never auto-include them into a save or reserve a dangling yaml id.
